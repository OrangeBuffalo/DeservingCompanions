...
namespace DeservingCompanions
{
    class Settings : AttributeGlobalSettings<Settings>
    {
        ...
        [SettingPropertyFloatingInteger("Companion XP Gains", 0.5f, 2f, "0%", Order = 0, RequireRestart = false, HintText = "Adjust the amount of XP gained by companions after a quest (Default=100%).")]
        ...
        [SettingPropertyFloatingInteger("Steward increase chance", 0f, 1f, "0%", Order = 0, RequireRestart = false, HintText = "Chance of gaining Steward skill XP after leading men in a quest (Default=50%).")]
        [SettingPropertyGroup("Deserving Companions")]
        public float StewardProba { get; set; } = 0.5f;

        [SettingPropertyFloatingInteger("Scouting increase chance", 0f, 1f, "0%", Order = 0, RequireRestart = false, HintText = "Chance of gaining Scouting skill XP after leading men in a quest (Default=50%).")]
        [SettingPropertyGroup("Deserving Companions")]
        public float ScoutingProba { get; set; } = 0.5f;

        [SettingPropertyFloatingInteger("Medicine increase chance", 0f, 1f, "0%", Order = 0, RequireRestart = false, HintText = "Chance of gaining Medicine skill XP after leading men in a quest (Default=25%).")]
        [SettingPropertyGroup("Deserving Companions")]
        public float MedicineProba { get; set; } = 0.25f;

        [SettingPropertyFloatingInteger("Tactics increase chance", 0f, 1f, "0%", Order = 0, RequireRestart = false, HintText = "Chance of gaining Tactics skill XP after leading men in a quest (Default=25%).")]
        [SettingPropertyGroup("Deserving Companions")]
